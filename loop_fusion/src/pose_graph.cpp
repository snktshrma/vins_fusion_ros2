...
void PoseGraph::optimize4DoF()
{
    while(true)
    {
        ...
        if (cur_index != -1)
        {
            ...
            ceres::LocalParameterization* angle_parameterization =
                new AngleLocalParameterization();
            ...
            for (it = keyframelist.begin(); it != keyframelist.end(); it++)
            {
                ...
                problem.AddParameterBlock(euler_array[i], 1, angle_parameterization);
    ...
    while(true)
    {
        ...
        if (cur_index != -1)
        {
            ...
            ceres::LocalParameterization* quaternion_parameterization =
                new camodocal::EigenQuaternionParameterization();
            ...
            for (it = keyframelist.begin(); it != keyframelist.end(); it++)
            {
                ...
                problem.AddParameterBlock(q_array[i], 4, quaternion_parameterization);
                problem.AddParameterBlock(t_array[i], 3);
